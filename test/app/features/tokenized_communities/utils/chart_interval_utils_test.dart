  ...
  group('timeUntilNextSlot', () {
    ...
    group('1m interval', () {
      test('mid-minute returns time until next minute + buffer', () {
        ...
        final result = timeUntilNextSlot('1m', buffer: buffer, now: now);
    ...
    group('3m interval', () {
      test('aligns to 3-minute boundaries', () {
        ...
        final result = timeUntilNextSlot('3m', buffer: buffer, now: now);
    ...
    group('5m interval', () {
      test('aligns to 5-minute boundaries', () {
        ...
        final result = timeUntilNextSlot('5m', buffer: buffer, now: now);
    ...
    group('15m interval', () {
      test('aligns to 15-minute boundaries', () {
        ...
        final result = timeUntilNextSlot('15m', buffer: buffer, now: now);
    ...
    group('1h interval', () {
      test('aligns to hour boundaries', () {
        ...
        final result = timeUntilNextSlot('1h', buffer: buffer, now: now);
    ...
    group('24h interval', () {
      test('returns time until next midnight + buffer', () {
        ...
        final result = timeUntilNextSlot('24h', buffer: buffer, now: now);
    ...
    group('edge cases', () {
      ...
      test('no buffer returns time until exact boundary', () {
        final now = DateTime(2026, 3, 17, 16, 30, 50);
        final result = timeUntilNextSlot('1m', now: now);
      ...
      test('returns buffer when wait is negative', () {
        ...
        final now = DateTime(2026, 3, 17, 16, 30);
        final result = timeUntilNextSlot('1m', buffer: Duration.zero, now: now);
