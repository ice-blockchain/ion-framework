...
_$SwapChainDataImpl _$$SwapChainDataImplFromJson(Map<String, dynamic> json) => _$SwapChainDataImpl(
...
Map<String, dynamic> _$$SwapChainDataImplToJson(_$SwapChainDataImpl instance) => <String, dynamic>{
