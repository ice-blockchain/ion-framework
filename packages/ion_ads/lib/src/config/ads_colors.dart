...
class AdsColorsExtension extends ThemeExtension<AdsColorsExtension> {
  AdsColorsExtension({
  ...
  factory AdsColorsExtension.defaultColors() {
    return AdsColorsExtension(
  ...
  @override
  ThemeExtension<AdsColorsExtension> copyWith({
    Color? primaryAccent,
    Color? primaryText,
    Color? secondaryText,
    Color? tertiaryText,
  ...
  @override
  ThemeExtension<AdsColorsExtension> lerp(
    covariant ThemeExtension<AdsColorsExtension>? other,
    double t,
  ) {
    if (other is! AdsColorsExtension) {
      return this;
    }
