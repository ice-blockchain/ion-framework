...
class TokenInfoMockHandler {
  ...
  static List<CommunityToken> get _mockTokens => [
    CommunityToken(
      ...
      marketData: MarketData(
        ...
        position: Position(
          ...
          rank: _random.nextInt(500) + 50,
          amountUSD: _random.nextDouble() * 50 + 0.01,
          pnl: _random.nextDouble() * 50 + 0.01,
          pnlPercentage: _random.nextDouble() * 50 + 0.01,
        ),
      ),
    ),
    CommunityToken(
    ...
    CommunityToken(
      ...
      title: 'Dev Token',
      description:
          'Artificial intelligence is no longer just a tool, but a co-author who changes the rules of the game in creativity and business.',
