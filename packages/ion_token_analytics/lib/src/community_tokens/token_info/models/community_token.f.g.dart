...
_$CommunityTokenImpl _$$CommunityTokenImplFromJson(Map<String, dynamic> json) =>
    _$CommunityTokenImpl(
      ...
      marketData: MarketData.fromJson(json['marketData'] as Map<String, dynamic>),
      createdAt: json['createdAt'] as String?,
    );

Map<String, dynamic> _$$CommunityTokenImplToJson(_$CommunityTokenImpl instance) =>
    <String, dynamic>{
      'type': instance.type,
...
_$CommunityTokenPatchImpl _$$CommunityTokenPatchImplFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$CommunityTokenPatchImplToJson(_$CommunityTokenPatchImpl instance) =>
    <String, dynamic>{
