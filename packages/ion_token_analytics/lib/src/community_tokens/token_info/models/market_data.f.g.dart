...
_$MarketDataImpl _$$MarketDataImplFromJson(Map<String, dynamic> json) => _$MarketDataImpl(
...
Map<String, dynamic> _$$MarketDataImplToJson(_$MarketDataImpl instance) => <String, dynamic>{
...
_$MarketDataPatchImpl _$$MarketDataPatchImplFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$MarketDataPatchImplToJson(_$MarketDataPatchImpl instance) =>
    <String, dynamic>{
