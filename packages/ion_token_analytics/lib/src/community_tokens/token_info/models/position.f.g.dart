...
_$PositionImpl _$$PositionImplFromJson(Map<String, dynamic> json) => _$PositionImpl(
...
Map<String, dynamic> _$$PositionImplToJson(_$PositionImpl instance) => <String, dynamic>{
  'rank': instance.rank,
...
_$PositionPatchImpl _$$PositionPatchImplFromJson(Map<String, dynamic> json) => _$PositionPatchImpl(
  rank: (json['rank'] as num?)?.toInt(),
  amount: (json['amount'] as num?)?.toDouble(),
  amountUSD: (json['amountUSD'] as num?)?.toDouble(),
  pnl: (json['pnl'] as num?)?.toDouble(),
...
Map<String, dynamic> _$$PositionPatchImplToJson(_$PositionPatchImpl instance) => <String, dynamic>{
