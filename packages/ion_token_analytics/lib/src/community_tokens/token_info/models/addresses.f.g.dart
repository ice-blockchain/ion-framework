...
_$AddressesImpl _$$AddressesImplFromJson(Map<String, dynamic> json) => _$AddressesImpl(
  blockchain: json['blockchain'] as String,
  ionConnect: json['ionConnect'] as String,
);

Map<String, dynamic> _$$AddressesImplToJson(_$AddressesImpl instance) => <String, dynamic>{
...
Map<String, dynamic> _$$AddressesPatchImplToJson(_$AddressesPatchImpl instance) =>
    <String, dynamic>{
