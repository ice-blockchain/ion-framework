...
import 'package:ion/app/features/feed/providers/token_creation_availability_provider.r.dart';
...
class _ContentEntityButton extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final isTokenCreationAvailable = ref.watch(
      tokenCreationAvailabilityProvider(entity: entity),
    );
    final hasToken = ref
