...
class RecordingOverlay extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    const navBarVerticalPadding = 8.0;
    final bottomOffset = getBottomPadding(context, navBarVerticalPadding: navBarVerticalPadding).s;

    return PositionedDirectional(
      bottom: bottomOffset + navBarVerticalPadding.s,
      end: 14.0.s,
      child: Container(
        width: 32.0.s,
