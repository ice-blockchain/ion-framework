...
class PushNotificationTranslations
  ...
  const factory PushNotificationTranslations({
    ...
    NotificationTranslation? replyArticle,
    NotificationTranslation? replyComment,
    NotificationTranslation? mention,
    NotificationTranslation? accountPost,
    NotificationTranslation? accountArticle,
    NotificationTranslation? accountVideo,
    NotificationTranslation? accountStory,
    NotificationTranslation? repost,
    NotificationTranslation? repostArticle,
    NotificationTranslation? repostComment,
    NotificationTranslation? quote,
    NotificationTranslation? quoteArticle,
    NotificationTranslation? quoteComment,
    NotificationTranslation? like,
    NotificationTranslation? likeArticle,
    NotificationTranslation? likeComment,
    NotificationTranslation? likeStory,
