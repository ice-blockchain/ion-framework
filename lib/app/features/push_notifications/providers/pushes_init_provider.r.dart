...
import 'package:ion/app/features/push_notifications/providers/push_subscription_external_sync_provider.r.dart';
...
void pushesInit(Ref ref) {
  ref
    ...
    ..listen(pushSubscriptionExternalSyncProvider, noop)
