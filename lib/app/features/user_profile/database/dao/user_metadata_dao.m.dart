...
UserMetadataDao userMetadataDao(Ref ref) {
  ...
  return UserMetadataDao(db: ref.watch(eventMessagesDatabaseProvider));
}

@DriftAccessor(tables: [UserMetadataTable])
class UserMetadataDao extends DatabaseAccessor<EventMessagesDatabase> with _$UserMetadataDaoMixin {
  UserMetadataDao({required EventMessagesDatabase db}) : super(db);
