...
ConversationDao conversationDao(Ref ref) =>
    ConversationDao(ref.watch(eventMessagesDatabaseProvider));
...
class ConversationDao extends DatabaseAccessor<EventMessagesDatabase> with _$ConversationDaoMixin {
