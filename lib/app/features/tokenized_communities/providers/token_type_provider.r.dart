...
// extension TokenTypeFromCommunityToken on CommunityToken {
//   CommunityContentTokenType get tokenType {
//     if (source.isTwitter) {
//       return CommunityContentTokenType.twitter;
//     } else {
//       final address = addresses.ionConnect;

//       if (address != null) {
//         if (address.startsWith(UserMetadataEntity.kind.toString())) {
//           return CommunityContentTokenType.profile;
//         } else if (address.startsWith(ArticleEntity.kind.toString())) {
//           return CommunityContentTokenType.postText;
//         }
//       }
