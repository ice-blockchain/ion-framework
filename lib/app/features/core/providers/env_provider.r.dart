...
class Env extends _$Env {
  ...
  T get<T>(EnvVariable variable) {
    return switch (variable) {
      ...
      EnvVariable.STORY_EXPIRATION_HOURS => const int.fromEnvironment('STORY_EXPIRATION_HOURS') as T,
      EnvVariable.USER_METADATA_SYNC_MINUTES => const int.fromEnvironment('USER_METADATA_SYNC_MINUTES') as T,
      EnvVariable.CHAT_PRIVACY_CACHE_MINUTES => const int.fromEnvironment('CHAT_PRIVACY_CACHE_MINUTES') as T,
      EnvVariable.EDIT_POST_ALLOWED_MINUTES => const int.fromEnvironment('EDIT_POST_ALLOWED_MINUTES') as T,
      EnvVariable.EDIT_MESSAGE_ALLOWED_MINUTES => const int.fromEnvironment('EDIT_MESSAGE_ALLOWED_MINUTES') as T,
      ...
      EnvVariable.GIFT_WRAP_EXPIRATION_HOURS => const int.fromEnvironment('GIFT_WRAP_EXPIRATION_HOURS') as T,
      ...
      EnvVariable.AF_ONE_LINK_TEMPLATE_ID => const String.fromEnvironment('AF_ONE_LINK_TEMPLATE_ID') as T,
      ...
      EnvVariable.NFT_IDENTITY_BASE_URL => const String.fromEnvironment('NFT_IDENTITY_BASE_URL') as T,
      EnvVariable.SHARE_APP_NAME => const String.fromEnvironment('SHARE_APP_NAME') as T,
      EnvVariable.CRYPTOCURRENCIES_SWAP_OKX_API_KEY => const String.fromEnvironment('CRYPTOCURRENCIES_SWAP_OKX_API_KEY') as T,
      EnvVariable.CRYPTOCURRENCIES_SWAP_OKX_SIGN_KEY => const String.fromEnvironment('CRYPTOCURRENCIES_SWAP_OKX_SIGN_KEY') as T,
      EnvVariable.CRYPTOCURRENCIES_SWAP_OKX_API_URL => const String.fromEnvironment('CRYPTOCURRENCIES_SWAP_OKX_API_URL') as T,
      EnvVariable.CRYPTOCURRENCIES_SWAP_OKX_PASSPHRASE => const String.fromEnvironment('CRYPTOCURRENCIES_SWAP_OKX_PASSPHRASE') as T,
      EnvVariable.CRYPTOCURRENCIES_BRIDGE_RELAY_BASE_URL => const String.fromEnvironment('CRYPTOCURRENCIES_BRIDGE_RELAY_BASE_URL') as T,
      EnvVariable.CRYPTOCURRENCIES_CEX_LETS_EXCHANGE_API_KEY => const String.fromEnvironment('CRYPTOCURRENCIES_CEX_LETS_EXCHANGE_API_KEY') as T,
      EnvVariable.CRYPTOCURRENCIES_CEX_LETS_EXCHANGE_API_URL => const String.fromEnvironment('CRYPTOCURRENCIES_CEX_LETS_EXCHANGE_API_URL') as T,
      EnvVariable.CRYPTOCURRENCIES_CEX_LETS_EXCHANGE_API_AFFILIATE_ID => const String.fromEnvironment('CRYPTOCURRENCIES_CEX_LETS_EXCHANGE_API_AFFILIATE_ID') as T,
      EnvVariable.CRYPTOCURRENCIES_CEX_EXOLIX_API_KEY => const String.fromEnvironment('CRYPTOCURRENCIES_CEX_EXOLIX_API_KEY') as T,
      EnvVariable.CRYPTOCURRENCIES_CEX_EXOLIX_API_URL => const String.fromEnvironment('CRYPTOCURRENCIES_CEX_EXOLIX_API_URL') as T,
    };
  }
}
