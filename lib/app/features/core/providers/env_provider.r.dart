...
enum EnvVariable {
  ...
  CRYPTOCURRENCIES_ION_BRIDGE_ROUTER_ADDRESS
}
...
class Env extends _$Env {
  ...
  T get<T>(EnvVariable variable) {
    return switch (variable) {
      ...
      EnvVariable.ION_TOKEN_ANALYTICS_BASE_URL => const String.fromEnvironment('ION_TOKEN_ANALYTICS_BASE_URL') as T,
      EnvVariable.CRYPTOCURRENCIES_BSC_RPC_URL => const String.fromEnvironment('CRYPTOCURRENCIES_BSC_RPC_URL') as T,
      ...
      EnvVariable.CRYPTOCURRENCIES_ION_BRIDGE_ROUTER_ADDRESS =>
        const String.fromEnvironment('CRYPTOCURRENCIES_ION_BRIDGE_ROUTER_ADDRESS') as T,
    };
  }
}
