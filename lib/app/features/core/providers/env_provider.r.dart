...
class Env extends _$Env {
  ...
  T get<T>(EnvVariable variable) {
    return switch (variable) {
      ...
      EnvVariable.LETS_EXCHANGE_API_KEY =>
        const String.fromEnvironment('LETS_EXCHANGE_API_KEY') as T,
      EnvVariable.LETS_EXCHANGE_API_URL =>
        const String.fromEnvironment('LETS_EXCHANGE_API_URL') as T,
      ...
      EnvVariable.LETS_EXCHANGE_API_AFFILIATE_ID =>
        const String.fromEnvironment('LETS_EXCHANGE_API_AFFILIATE_ID') as T,
    };
  }
}
