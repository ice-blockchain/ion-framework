...
class SendDisabledNotifier extends _$SendDisabledNotifier {
  ...
  Future<void> _checkSendDisabled() async {
    ...
    final isSellBuyCoinNull = network == null || coin == null;
    final isSellNetworkNotBsc = !(network?.isBsc ?? false);
    final isSellCoinNotIon = coin?.coinsGroup.abbreviation.toUpperCase() != 'ION';
